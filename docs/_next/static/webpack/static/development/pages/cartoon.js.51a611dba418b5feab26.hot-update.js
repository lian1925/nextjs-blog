...
})(["width:780px;background-color:white;border:1.5px solid #071419;border-radius:12px;display:flex;flex-direction:column;align-items:flex-start;justify-content:space-evenly;padding:10px;margin-top:20px;p{padding-left:10px;margin-bottom:0;}h2{margin:0;font-size:18px;padding:10px;width:100%;border-bottom:1px solid #071419;}*:focus{outline:0 !important;}textarea{resize:none;margin:10px 0;}"]);
...
//# sourceMappingURL=cartoon.js.51a611dba418b5feab26.hot-update.js.map