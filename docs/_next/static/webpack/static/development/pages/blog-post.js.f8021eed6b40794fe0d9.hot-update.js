...
var getPageJson = function getPageJson(router) {
  ...
  if (router.asPath) {
    var asPath = router.asPath.split("/article").join("");
...
//# sourceMappingURL=blog-post.js.f8021eed6b40794fe0d9.hot-update.js.map