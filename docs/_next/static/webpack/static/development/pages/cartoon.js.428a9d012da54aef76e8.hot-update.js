...
})(["width:780px;background-color:white;border:1.5px solid #071419;border-radius:12px;display:flex;flex-direction:column;align-items:flex-start;justify-content:space-evenly;padding:10px;margin-top:20px;p{padding-left:10px;margin-bottom:5px;}*:focus{outline:0 !important;}"]);
...
})(["width:100%;margin-left:10px;h2{margin:0;font-size:18px;padding:10px;width:100%;border-bottom:1px solid #071419;}textarea{resize:none;}span{margin-left:10px;color:#999;}"]);
...
//# sourceMappingURL=cartoon.js.428a9d012da54aef76e8.hot-update.js.map