...
})(["width:780px;background-color:white;border:1.5px solid #071419;border-radius:12px;display:flex;flex-direction:column;align-items:stretch;padding:10px;margin-top:20px;p{padding-left:10px;margin-bottom:5px;}h2{font-size:18px;padding:10px;width:95%;border-bottom:1px solid #071419;}*:focus{outline:0 !important;}"]);
...
})(["font-size:14px;padding:0 5px;float:right;"]);

/***/ })

})
//# sourceMappingURL=cartoon.js.12bad1acd2c610aa1904.hot-update.js.map