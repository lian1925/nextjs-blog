...
var Index = function Index(props) {
  ...
  var goTo = function goTo(state) {
    ...
    if (id < 0) {
      id = 0;
      react_toastify__WEBPACK_IMPORTED_MODULE_4__["toast"].info("🤷 ✈️ 已经是最新一张", {
        position: "top-center",
        autoClose: 3000,
    ...
    if (id >= data.sum) {
      id = data.sum - 1;
      react_toastify__WEBPACK_IMPORTED_MODULE_4__["toast"].info("🤷 ✈️ 没哟", {
        position: "top-center",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
...
//# sourceMappingURL=cartoon.js.2fbb620ecbe6bacf5735.hot-update.js.map