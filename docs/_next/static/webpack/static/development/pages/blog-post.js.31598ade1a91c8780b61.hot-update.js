...
var getPageJson = function getPageJson(router) {
  ...
  if (router.asPath) {
    pageJson = __webpack_require__("./blog sync recursive ^\\.\\/dist.*\\.json$")("./dist".concat(router.query.fullUrl.split("/article").join(""), ".json"));
  }
...
//# sourceMappingURL=blog-post.js.31598ade1a91c8780b61.hot-update.js.map